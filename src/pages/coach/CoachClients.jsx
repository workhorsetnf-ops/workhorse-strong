...
export default function CoachClients() {
  ...
  async function startEdit(c) {
    ...
    setCalcResult(null)
    setForm({ full_name: c.full_name, phase: c.phase, protein_g: c.protein_g, carbs_g: c.carbs_g, fat_g: c.fat_g, calories: c.calories, email: c.email || '', checkin_day: c.checkin_day ?? null, status: c.status || 'active', payment_plan: c.payment_plan || '', contract_ends: c.contract_ends || '', split_ends: c.split_ends || '' })
            ...
            {editing === c.id ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <div style={{ borderTop: '1px solid var(--line)', paddingTop: 10 }}>
                  <span className="eyebrow" style={{ fontSize: 10 }}>Billing</span>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10 }}>
                <div>
                  ...
                  {(c.payment_plan || c.contract_ends || c.split_ends) && (
                    <div className="muted" style={{ fontSize: 12, marginTop: 3 }}>
                      {c.payment_plan && <>{c.payment_plan}</>}
