...
export default function ClientFAQ() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div className="card" style={{ background: '#fff', color: '#111' }}>
          {hub.banner_url ? (
            ...
            <div style={{ background: '#0A0A0A', borderRadius: 8, padding: '18px 20px', textAlign: 'center' }}>
              <div style={{ fontFamily: "'Anton', sans-serif", fontSize: 24, color: '#fff', letterSpacing: '0.04em' }}>{hub.title}</div>
            </div>
          )}
      ...
      <style>{`
        .hub-preview h1, .hub-preview h2 { font-family: 'Anton', sans-serif; letter-spacing: 0.03em; color: #111; margin-top: 18px; }
        .hub-preview h2 { border-bottom: 2px solid #FF5A00; padding-bottom: 4px; font-size: 19px; }
        ...
        .hub-preview strong { color: #FF5A00; }
        ...
        .hub-preview summary::before { content: '▸'; color: #FF5A00; margin-right: 8px; display: inline-block; }
